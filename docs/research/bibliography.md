...
The two architecture-critical full reports are published under [`docs/research/`](./). The remaining reports were synthesized into the original ideation document and subsequently decomposed into `docs/foundations/` and `docs/specs/`.
