...
- [ ] T1: Add profile write constraints to `protocols/challenger.md` → `src/sensei/engine/protocols/challenger.md`
- [ ] T2: Add profile write constraints to `protocols/reviewer.md` → `src/sensei/engine/protocols/reviewer.md`
- [ ] T3: Run full test suite → verify (depends: T1, T2)

## Acceptance Criteria

- [ ] AC1: Challenger and reviewer E2E tests pass (LLM no longer adds extra fields)
- [ ] AC2: Protocol prose explicitly names the allowed profile fields
