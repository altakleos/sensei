...
- [x] T1: Create `tests/e2e/test_mode_transition_e2e.py` → `tests/e2e/test_mode_transition_e2e.py`
...
- [x] T3: Mark plan done, add to plans index (depends: T2)

## Acceptance Criteria

- [x] AC1: E2E test passes with Kiro (via agent_runner)
- [x] AC2: Profile shows evidence of multi-turn interaction (attempts >= 4)
