...
- [x] **1. tutor.md — Add "Granularity check" mid-session trigger**
...
- [x] **2. assess.md — Add "Granularity diagnosis" branch to Step 8**
...
- [x] **3. defaults.yaml — Add `max_decompose_children` knob**
