...
- [ ] T36: Manual pre-release gate on workstation: `ANTHROPIC_API_KEY=... pytest tests/e2e/ -v` — one test passes, schema-valid goal file produced. **If this fails, do NOT tag v0.1.0a9.**
