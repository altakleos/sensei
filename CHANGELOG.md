...
- docs: `docs/specs/README.md` spec template grows `fixtures:` and `fixtures_deferred:` fields plus a short section explaining the fixture-naming convention. Couples new decisions to verification evidence per ADR-0011 and the a9 methodology gate.
